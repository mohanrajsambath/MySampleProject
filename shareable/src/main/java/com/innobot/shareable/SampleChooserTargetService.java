...
public class SampleChooserTargetService extends ChooserTargetService {
    ...
    public List<ChooserTarget> onGetChooserTargets(ComponentName targetActivityName, IntentFilter matchedFilter) {
       ...
       /* ComponentName componentName = new ComponentName(getPackageName(),
        ...
        Contact contact = Contact.byId(0);
        targets.add(new ChooserTarget(contact.getName(), Icon.createWithResource(this, (R.drawable.ic_vmail_bg)), 0.5f, componentName, extras));*/
